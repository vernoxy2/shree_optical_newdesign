  ...
  return (
    <section className="container mt-10 md:pt-36">
      <div className="w-full bg-primary  ">
        ...
        >
          <div className="w-full px-7 md:px-14 flex flex-col  gap-4 lg:gap-8 pt-10 xl:py-10">
            <h2
              data-aos="fade-right"
              className="text-2xl md:text-4xl 2xl:text-5xl font-normal text-white font-kaisei_Decol text- lg:text-left"
            >
              Our Shop Story
            </h2>
            ...
            <p
              data-aos="fade-right"
              className="text-base md:text-xl xl:text-2xl font-normal text-white font-kanit text- lg:text-left leading-normal xl:pr-16"
            >
            ...
            <hr className="border-[1px] md:border-2 border-white rounded-full w-40" />
